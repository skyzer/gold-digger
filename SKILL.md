...
- **No Hermes `xai-oauth`** — skip X/KOL signal by default; separately billed `XAI_API_KEY` and `X_BEARER_TOKEN` paths require explicit `GOLD_DIGGER_ALLOW_PAID_X_FALLBACK=1` opt-in
